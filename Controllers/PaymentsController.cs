...
namespace _Morafiq.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentId,OrderId,Amount,TransactionDate")] Payment payment)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Orders, "OrderId", "Status", payment.OrderId);
            return View(payment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,OrderId,Amount,TransactionDate")] Payment payment)
        {
